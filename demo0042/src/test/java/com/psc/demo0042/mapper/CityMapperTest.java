package com.psc.demo0042.mapper;
...
public class CityMapperTest {
	...
	@Test
	@Transactional
	public void A003_시티1_입력() throws Exception {
	...
	@Test
	public void A004_시티1_조회() throws Exception {
	...
	@Test
	@Transactional
	public void B001_시티2_테이블_삭제() throws Exception {
		cityMapper2.dropCity2();
	}
	
	@Test
	@Transactional
	public void B002_시티2_테이블_생성() throws Exception {
	...
	@Test
	@Transactional
	public void B003_시티2_입력()  throws Exception{
		List<City> cityList = new ArrayList<City>();
		City city;
	...
	@Test
	public void B004_시티2_조회()  throws Exception{
