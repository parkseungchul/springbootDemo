...
public interface EmpRepository2 extends CrudRepository<Emp2, Integer>{
	 ...
	 * @return
	 */
	@Query("SELECT new com.psc.demo0041.dto.EmpDto(E.empno, E.ename, E.job, E.mgr, E.hiredate, E.sal, E.comm, D.deptno) FROM Emp2 E LEFT OUTER JOIN Dept2 D ON D.deptno = E.dept.deptno WHERE D.deptno = :deptno")
