package com.psc.demo0041.db1.repository;
...
import com.psc.demo0041.dto.EmpDto;
...
public interface EmpRepository1 extends CrudRepository<Emp1, Integer>{
	 ...
	 * @return
	 */
	@Query("SELECT new com.psc.demo0041.dto.EmpDto(E.empno, E.ename, E.job, E.mgr, E.hiredate, E.sal, E.comm, D.deptno) FROM Emp1 E LEFT OUTER JOIN Dept1 D ON D.deptno = E.dept.deptno WHERE D.deptno = :deptno")
